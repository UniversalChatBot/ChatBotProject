 ...
 *
 */
internal class InternalObjectContainer : IMutableObjectsContainer {
    ...
    override fun <T : Any> put(data: T, superClass: Array<KClass<in T>>) = lock {
        if (data is KClass<*> ||
            ...
            throw RuntimeException("STOP！请勿添加 CLASS")
        }
    ...
    private fun <T : Any> lock(func: IMutableObjectsContainer.() -> T): T {

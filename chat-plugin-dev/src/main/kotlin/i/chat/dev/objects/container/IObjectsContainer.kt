...
interface IObjectsContainer {
    ...
    /**
     * @see IObjectsContainer.get(KClass)
     *
     */
    fun <T : Any> from(clazz: KClass<T>): ReadOnlyProperty<Any?, T>

    /**
     * @see IObjectsContainer.get(String)
     */
...
inline fun <reified T : Any> IObjectsContainer.from(): ReadOnlyProperty<Any?, T> {
    return from(T::class)
}

inline fun <reified T : Any> IObjectsContainer.get(): T {
    return get(T::class)
}
